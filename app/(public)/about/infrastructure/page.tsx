      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-[#1a3c6e]">Facilities & <span className="text-[#c8a951]">Amenities</span></h2>
            ...
            {facilities.map((f) => {
              ...
              return (
                <div key={f.title} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                  ...
                  <h3 className="font-bold text-[#1a3c6e] text-base mb-2 group-hover:text-[#c8a951] transition-colors">{f.title}</h3>
