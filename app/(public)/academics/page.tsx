  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#c8a951] mb-3">
                <span className="w-8 h-0.5 bg-[#c8a951] rounded" /> Our Curriculum
              </div>
              <h2 className="text-3xl font-black text-[#1a3c6e] mb-6">CBSE <span className="text-[#c8a951]">Curriculum</span></h2>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-[#1a3c6e] text-lg mb-4">Classes & Subjects</h3>
              {[
                ...
                <div key={item.level} className="bg-[#f0f4ff] rounded-xl p-5 border border-[#1a3c6e]/10 hover:shadow-md transition-shadow">
                  <h4 className="font-bold text-[#1a3c6e] mb-1 text-sm">{item.level}</h4>
                  <p className="text-xs text-gray-600 mb-2">{item.subjects}</p>
                  <p className="text-xs text-[#c8a951] font-semibold">{item.approach}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-[#f8f9ff]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-[#1a3c6e]">Our Teaching <span className="text-[#c8a951]">Approach</span></h2>
            ...
            {[
              ...
              return (
                <div key={item.title} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="font-bold text-[#1a3c6e] text-base mb-2">{item.title}</h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-[#1a3c6e]">Beyond <span className="text-[#c8a951]">Textbooks</span></h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              const Icon = item.icon
              return (
                <div key={item.title} className="bg-[#f0f4ff] rounded-2xl p-5 border border-[#1a3c6e]/10 text-center hover:shadow-md transition-shadow">
      ...
      <section className="py-20 bg-gradient-to-br from-[#1a3c6e] to-[#0d1f3c] text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black">Co-Curricular <span className="text-[#c8a951]">Activities</span></h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              ...
              <div key={activity} className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-lg p-3">
                <CheckCircle2 className="w-4 h-4 text-[#c8a951] flex-shrink-0" />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-black text-[#1a3c6e]">Assessment <span className="text-[#c8a951]">Pattern</span></h2>
              ...
              {[
                ...
                <div key={item.title} className="flex gap-4 p-5 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex-shrink-0 w-16 text-center">
                    <span className="text-[10px] font-bold text-[#c8a951] bg-[#c8a951]/10 px-2 py-1 rounded">{item.freq}</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-[#1a3c6e] text-sm">{item.title}</h4>
            ...
            <div className="mt-8 bg-[#f0f4ff] rounded-xl p-5 border border-[#1a3c6e]/10 text-center">
              <p className="text-sm text-gray-600">
                <strong className="text-[#1a3c6e]">Note:</strong> We believe in continuous improvement, not pressure. Every child is encouraged to do their personal best. Report cards reflect effort, behaviour, and participation alongside marks.
              </p>
            </div>
          </div>
        </div>
