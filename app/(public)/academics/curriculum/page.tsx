  ...
  return (
    <>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-black text-[#1e40af] mb-6">CBSE <span className="text-[#FF9933]">Framework</span></h2>
      ...
      <section className="py-20 bg-[#f5f9ff]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-[#1e40af]">How We <span className="text-[#FF9933]">Teach</span></h2>
            ...
            {[
              ...
              return (
                <div key={item.title} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm text-center">
                  ...
                  <h4 className="font-bold text-[#1e40af] text-sm mb-2">{item.title}</h4>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-black text-[#1e40af] mb-6">Medium of <span className="text-[#FF9933]">Instruction</span></h2>
            <div className="bg-[#eff6ff] rounded-xl p-6 border border-[#1e40af]/10">
              <p className="text-gray-600 text-sm leading-relaxed">
                The primary medium of instruction is <strong className="text-[#1e40af]">English</strong>, with <strong className="text-[#1e40af]">Hindi</strong> used to support understanding where needed, especially in junior classes. We believe a bilingual approach helps children from diverse backgrounds feel comfortable while gradually building English proficiency. From Class VI onwards, English is the primary language for all subjects except Hindi and Sanskrit.
              </p>
            </div>
          </div>
        </div>
