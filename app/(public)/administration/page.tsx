      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-[#1a3c6e]">School <span className="text-[#c8a951]">Leadership</span></h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {leaders.map((leader) => (
              ...
              >
                <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-[#1a3c6e] to-[#0d1f3c] flex items-center justify-center text-white font-black text-2xl mb-5 group-hover:scale-105 transition-transform shadow-lg">
                  {leader.initials}
                </div>
                <h3 className="font-bold text-[#1a3c6e] text-lg group-hover:text-[#c8a951] transition-colors">{leader.name}</h3>
                <p className="text-sm text-[#c8a951] font-semibold mt-1">{leader.role}</p>
                <p className="text-xs text-gray-500 italic mt-3 leading-relaxed">"{leader.quote}"</p>
                <div className="mt-5 inline-flex items-center gap-1.5 text-xs font-semibold text-[#1a3c6e] group-hover:text-[#c8a951] transition-colors">
