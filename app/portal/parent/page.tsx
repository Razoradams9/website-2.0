...
export default function ParentPortalPage() {
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {/* Children Cards */}
      <div>
        <h2 className="text-lg font-bold text-[#1a3c6e] mb-4 flex items-center gap-2">
          <Users className="w-5 h-5 text-[#c8a951]" /> Your Children
        </h2>
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-xl bg-[#1a3c6e] flex items-center justify-center text-white font-black text-xl">R</div>
              <div>
                <p className="font-bold text-[#1a3c6e]">Rahul Singh</p>
            ...
            <div className="grid grid-cols-3 gap-3 mt-4 pt-4 border-t border-gray-100">
              <div className="text-center">
                <p className="text-lg font-black text-[#1a3c6e]">94%</p>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <CreditCard className="w-5 h-5 text-[#c8a951]" /> Fee Status
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <ClipboardCheck className="w-5 h-5 text-[#c8a951]" /> Attendance (August 2025)
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <Bell className="w-5 h-5 text-[#c8a951]" /> Notices for Parents
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={n.title} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100">
                  <div className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${n.urgent ? "bg-red-500" : "bg-[#c8a951]"}`} />
                  <div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <Calendar className="w-5 h-5 text-[#c8a951]" /> Upcoming Events
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={e.title} className="flex items-center gap-3 p-3 bg-[#f0f4ff] rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-[#1a3c6e] truncate">{e.title}</p>
