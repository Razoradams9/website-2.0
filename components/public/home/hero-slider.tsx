          ...
          <div className="max-w-3xl">
            ...
            {current === 0 && (
              <div className="mb-8 animate-fade-in">
                <img src="https://drive.google.com/uc?export=view&id=1sIthpiMwvMfJRQ-bAibcvKZrOMZqB0Pi" alt="Guru Gorakshnath Gyanasthali" className="w-28 h-28 sm:w-36 sm:h-36 object-contain drop-shadow-2xl" />
              </div>
            )}
