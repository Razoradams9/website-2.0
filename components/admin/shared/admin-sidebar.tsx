      ...
      <div className="h-16 lg:h-20 flex items-center justify-between px-4 border-b border-gray-100 flex-shrink-0">
        {!collapsed && (
          <Link href="/admin/dashboard" className="flex items-center gap-2.5">
            <img src="/images/logo.png" alt="GGG" className="w-9 h-9 rounded-lg object-contain" />
            <div>
              <p className="text-sm font-black text-[#1a3c6e] leading-tight">GGG Admin</p>
              ...
              <div key={item.label}>
                <button
                  ...
                  className={cn(
                    ...
                    isChildActive ? "text-[#1a3c6e] bg-[#f0f4ff]" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                  )}
                >
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            active ? "bg-[#1a3c6e] text-white" : "text-gray-500 hover:bg-gray-50 hover:text-gray-800"
                          )}
                        >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active ? "bg-[#1a3c6e] text-white shadow-sm" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
              )}
            >
              <Icon className="w-[18px] h-[18px] flex-shrink-0" />
